// Package api is the public REST edge: six routes, each a dmpfhttp.Route that
...
func Routes(budget deadline.Budget) []dmpfhttp.Route {
...
func NewHandler(
	...
	admit := dmpfhttp.Admission(ctrl, routeOf, tenantOf, instruments, refuseAsRejection)
