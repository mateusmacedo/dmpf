...
var (
	ErrUnknownRole     = errors.New("dmpf-reference-orders: unknown role")
	ErrMissingVariable = errors.New("dmpf-reference-orders: required variable is not set")
	ErrInvalidVariable = errors.New("dmpf-reference-orders: variable has an invalid value")
)
