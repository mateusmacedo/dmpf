...
func New(t testing.TB) Harness {
	...
	h := Harness{
		Brokers: seeds,
		Pool:    pool,
		Topic:   "dmpf-distkit-bookings-" + suffix,
		Group:   "dmpf-distkit-bookings-group-" + suffix,
		DLQ:     "dmpf-distkit-bookings-" + suffix + "-dlq",
	}
...
func (h Harness) Start(t testing.TB, role Role) *Process {
	...
	cmd.Env = append(os.Environ(),
		...
		"KAFKA_BOOKINGS_TOPIC="+h.Topic,
		"KAFKA_BOOKINGS_DLQ="+h.DLQ,
		"KAFKA_GROUP="+h.Group,
		"KAFKA_INSECURE=true",
		"SERVICE=bookings-distkit",
