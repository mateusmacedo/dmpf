...
func write[R any](ctx context.Context, s Service, operation string, execution ports.ExecutionContext, cmd Operation, order domain.OrderID, decide decision[R]) (application.Outcome[R], error) {
