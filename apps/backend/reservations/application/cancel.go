...
func (s Service) Cancel(ctx context.Context, execution ports.ExecutionContext, cmd Cancel) (application.Outcome[domain.CancelledResponse], error) {
	return write(ctx, s, OperationCancel, execution, cmd, cmd.Order,
