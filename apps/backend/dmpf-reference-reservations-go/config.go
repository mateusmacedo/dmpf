...
var (
	ErrUnknownRole     = errors.New("dmpf-reference-reservations: unknown role")
	ErrMissingVariable = errors.New("dmpf-reference-reservations: required variable is not set")
	ErrInvalidVariable = errors.New("dmpf-reference-reservations: variable has an invalid value")
)
...
func Defaults(role Role) Config {
	return Config{
		Role:     role,
		GRPCAddr: ":9090",
		Service:  "dmpf-reference-reservations",
		Version:  "dev",
		Relay: relay.Config{
