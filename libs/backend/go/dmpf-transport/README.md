...
lugar neutro para isso, e `dmpf-observability` é nomeado por FND-08, não por
...
| --- | --- | --- |
| `dmpf-kernel/transport` | `provider` | raiz do módulo, `deadline`, `channel`, `attempt`, `admission`, `observe`, `compose` |
