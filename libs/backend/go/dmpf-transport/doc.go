...
// Package dmpftransport holds the transport primitives the four DMPF transport
...
// composes these primitives with the decorators of dmpf-observability (KRN-09)
// and realizes the ports of dmpf-ports (KRN-04) against a concrete transport.
//
