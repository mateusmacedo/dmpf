...
func (c *countingClock) Now() dmpfports.Instant {
	c.calls++
	return c.at
}
...
func (g *countingIDs) NewMessageID() dmpfports.MessageID {
	g.calls++
	return dmpfports.MessageID(fmt.Sprintf("%s%06d", g.prefix, g.calls))
}

type fixedIDs struct{ id dmpfports.MessageID }

func (g fixedIDs) NewMessageID() dmpfports.MessageID { return g.id }
...
func TestResolveIdentityReadsTheClockOnceAndTakesOneIDPerEvent(t *testing.T) {
	...
	id := dmpfapplication.ResolveIdentity(clock, ids, 2)
...
func TestResolveIdentityStillReadsTheClockWithoutEvents(t *testing.T) {
	...
	id := dmpfapplication.ResolveIdentity(clock, ids, 0)
...
func TestResolveIdentityPanicsOnAnEmptyIdentifier(t *testing.T) {
	...
	_ = dmpfapplication.ResolveIdentity(&countingClock{}, fixedIDs{id: ""}, 1)
}
...
func TestResolveIdentityPanicsOnARepeatedIdentifier(t *testing.T) {
	...
	_ = dmpfapplication.ResolveIdentity(&countingClock{}, fixedIDs{id: "m-000001"}, 2)
}
...
func TestResolveIdentityPanicsOnANegativeEventCount(t *testing.T) {
	...
	_ = dmpfapplication.ResolveIdentity(&countingClock{}, &countingIDs{prefix: "m-"}, -1)
}
