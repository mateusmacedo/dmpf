...
func NewReader(pool *pgxpool.Pool) ports.Reader[orders.OrderID, orders.Snapshot] {
	return reader{pool: pool}
}

type reader struct{ pool *pgxpool.Pool }

func (r reader) Load(ctx context.Context, id orders.OrderID) (orders.Snapshot, ports.Version, error) {
