...
// counterService is the fixture use case of this package: the nine steps of
// FND-04 §3.2 over the smallest aggregate that has both branches, so the kit is
// proved on a service the kernel owns.
