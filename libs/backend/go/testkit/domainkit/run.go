...
type Subject[S, R any] struct {
	...
	Decide func(S) (domain.Accepted[R], *domain.Rejection)
	...
	Event func(domain.DomainEvent) (string, Fields)
...
func project(events []domain.DomainEvent, projectEvent func(domain.DomainEvent) (string, Fields)) []Event {
...
func detailFields(details []domain.Detail) Fields {
	out := Fields{}
