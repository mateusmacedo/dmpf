...
import conffit "github.com/mateusmacedo/dmpf/libs/backend/go/conformance/fitness"
...
const (
	...
	whereChecker  = "conformance/internal/conformance/vectors_test.go (reused, FIT-02)"
