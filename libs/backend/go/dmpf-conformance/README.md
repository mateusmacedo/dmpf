...
| --- | --- | --- |
| `DMPF-U*`, `DMPF-M*`, `DMPF-T*`, `DMPF-D*`, `DMPF-E*` | RFC §10.3 | `dmpf-conformance` |
...
| --- | --- | --- |
| `dmpf-conformance/rule` | `domain` | `internal/rule` |
| `dmpf-conformance/manifest` | `domain` | `internal/manifest` |
| `dmpf-conformance/baseline` | `domain` | `internal/baseline` |
| `dmpf-conformance/exception` | `domain` | `internal/exception` |
| `dmpf-conformance/port` | `port` | `internal/port` |
| `dmpf-conformance/conformance` | `application` | `internal/conformance` |
| `dmpf-conformance/fsstore` | `provider` | `internal/fsstore` |
| `dmpf-conformance/golist` | `provider` | `internal/golist` |
| `dmpf-conformance/cmd` | `app` | `cmd/dmpf-conformance` |
| `dmpf-conformance/fitness` | `app` | `fitness` |
| `dmpf-conformance/bom` | `app` | `bom` |
| `dmpf-conformance/cmd-bom` | `app` | `cmd/dmpf-bom` |
