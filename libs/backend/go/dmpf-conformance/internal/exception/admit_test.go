...
func admissivel() exception.Exception {
	return exception.Exception{
		...
		Object: exception.Object{
			...
			Unit:            "dmpf-kernel/provider-postgres",
...
func TestCatalogoFechadoRecusaUmVetorPorItem(t *testing.T) {
	casos := []struct {
		...
		{"N2 aresta", "dmpf-kernel/domain->dmpf-kernel/provider-postgres", rule.CodeX003},
		...
		{"N5 bounded context", "bounded_context:dmpf-kernel", rule.CodeX004},
