...
type decision[R any] func(*reservations.Reservation, reservations.Instant) (domain.Accepted[R], *domain.Rejection)
...
func write[R any](ctx context.Context, s Service, operation string, cmd Command, order reservations.OrderID, decide decision[R]) (application.Outcome[R], error) {
...
func loadOrCreate(ctx context.Context, res Resources, id reservations.OrderID) (*reservations.Reservation, ports.Version, error) {
