...
// Package dmpfpostgres realizes the provider block of the DMPF kernel over
// PostgreSQL: the UnitOfWork[R], Repository[ID, S] and Outbox ports that
// dmpf-ports and dmpf-application fixed in domain types (KRN-04), backed by a
...
// of RFC §7.3, so no file here imports dmpf-application, and the reverse
