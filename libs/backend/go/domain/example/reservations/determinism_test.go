...
func sameSequence(t *testing.T, a, b []domain.DomainEvent) {
	t.Helper()
	if len(a) != len(b) {
...
var (
	...
	_ = mustBeComparable[reservations.CancelledResponse]
	_ = mustBeComparable[reservations.ReservationCancelled]
	_ = mustBeComparable[reservations.Cancel]
)
