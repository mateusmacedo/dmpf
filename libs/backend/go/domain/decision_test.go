...
func sameEvents(t *testing.T, got []domain.DomainEvent, want ...domain.DomainEvent) {
	t.Helper()
	if len(got) != len(want) {
...
func TestAcceptExposesResponseAndOrderedEvents(t *testing.T) {
	...
	acc := domain.Accept(stubResponse{42}, e1, e2)
...
func TestAcceptInputSliceIsNotAliased(t *testing.T) {
	e1, e2 := stubEvent{1}, stubEvent{2}
	src := []domain.DomainEvent{e1, e2}
	acc := domain.Accept(stubResponse{1}, src...)
...
func TestEventsReturnedSliceIsNotAliased(t *testing.T) {
	...
	acc := domain.Accept(stubResponse{1}, e1, e2)
...
func TestEventsWithoutEventsIsEmptyNotNil(t *testing.T) {
	acc := domain.Accept(stubResponse{1})
...
func TestZeroAcceptedHasNoEvents(t *testing.T) {
	var acc domain.Accepted[stubResponse]
...
func TestAcceptEmptyResponse(t *testing.T) {
	acc := domain.Accept(domain.Empty{})

	if acc.Response() != (domain.Empty{}) {
