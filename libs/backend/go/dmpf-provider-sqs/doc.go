...
// Package dmpfsqs realizes the normalized asynchronous transport over SNS and
...
// dmpf-ports — Acknowledger and Containment — and the structural shape of the
// relay's Publisher, and never imports dmpf-app or dmpf-application.
//
