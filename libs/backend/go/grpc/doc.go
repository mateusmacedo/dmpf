...
// Package grpc realizes the internal synchronous transport of the DMPF
...
// admission of observability at the server boundary.
//
// It is a provider-block unit. It composes transport/deadline with the
// decorators of observability (KRN-09) and never imports app or
// application (cells 26 and 27 of RFC §7.3).
//
