...
// Package dmpfhttp realizes the external synchronous transport of the DMPF
...
// idempotent methods, and the admission of dmpf-observability per route and
// tenant.
//
// It is a provider-block unit over the standard library alone: no HTTP
// framework enters the kernel. It composes dmpf-transport/deadline with the
// decorators of dmpf-observability (KRN-09).
//
