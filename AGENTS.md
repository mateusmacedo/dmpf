...
├── libs/
│   ├── backend/go/                 # 7 módulos Go: dmpf-domain, dmpf-conformance, dmpf-contracts, dmpf-ports, dmpf-application, dmpf-provider-postgres, dmpf-app
│   ├── frontend/                   # placeholder — sem projeto Nx
