...
├── libs/
│   ├── backend/go/                 # 4 módulos Go: dmpf-domain, dmpf-conformance, dmpf-ports, dmpf-application
│   ├── frontend/                   # placeholder — sem projeto Nx
