...
go run ./tools/dmpf-conformance/cmd/modsync --root . --check          # go.work (use/replace) e requires dos go.mod em dia com os módulos da árvore; --write regrava
